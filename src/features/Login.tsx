...
const handleLogoutSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    return(
        <div>
            { token && token.length > 0? (<div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-md space-y-8">
                <div>
                <h3 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">You have successfully logged in!</h3>
                </div>
